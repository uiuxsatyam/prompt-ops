...
const skills: Skill[] = [
  ...
  // Premium Skills
  { name: "Design System Architect", category: "Design & UX", desc: "Build scalable design systems from scratch.", price: "$7.99", icon: Layers },
  { name: "Figma-to-Code Sentinel", category: "Design & UX", desc: "Deterministic conversion of design to production code.", price: "$7.99", icon: MonitorOff },
  { name: "Full-Stack Sprint Master", category: "Engineering", desc: "Accelerate full-stack feature development.", price: "$7.99", icon: Rocket },
  { name: "Backend Engine v3", category: "Engineering", desc: "Robust API and database architecture logic.", price: "$7.99", icon: ServerCog },
  { name: "Frontend Component Factory", category: "Engineering", desc: "Atomic component generation at scale.", price: "$7.99", icon: Cpu },
  { name: "The Intelligence Hub", category: "Data & Marketing", desc: "Market sentiment and data analysis frameworks.", price: "$7.99", icon: BrainCircuit },
  { name: "Marketing Pulse Monitor", category: "Data & Marketing", desc: "Autonomous campaign performance tracking.", price: "$7.99", icon: Megaphone },
  { name: "SQL Synthesis Protocol", category: "Data & Marketing", desc: "Natural language to complex SQL query logic.", price: "$7.99", icon: Briefcase },
  { name: "QA Sentinel Pro", category: "Testing & QA", desc: "Automated end-to-end testing protocols.", price: "$7.99", icon: FileCheck2 },
  { name: "Edge Case Architect", category: "Testing & QA", desc: "Discover critical edge cases before deployment.", price: "$7.99", icon: Bug },
  { name: "Test Suite Generator", category: "Testing & QA", desc: "Comprehensive unit and integration test suites.", price: "$7.99", icon: Settings2 },
  { name: "DevOps Engine Pro", category: "Deployment & Ops", desc: "CI/CD and infrastructure orchestration.", price: "$7.99", icon: Cloud },
  { name: "Infra Architect", category: "Deployment & Ops", desc: "Cloud infrastructure-as-code synthesis.", price: "$7.99", icon: Terminal },
  { name: "Scaling Protocol", category: "Deployment & Ops", desc: "Logic for scaling distributed systems.", price: "$7.99", icon: LineChart },
  { name: "Security Sentinel", category: "Audit & Monitoring", desc: "Continuous security and vulnerability auditing.", price: "$7.99", icon: Lock },
  { name: "Performance Architect", category: "Audit & Monitoring", desc: "System performance and latency optimization.", price: "$7.99", icon: Zap },
  { name: "Compliance Engine", category: "Audit & Monitoring", desc: "Regulatory and compliance check protocols.", price: "$7.99", icon: ShieldCheck },
];
